...
$sql1 = $koneksi->query("SELECT i.*, d.nama_departemen FROM informasi_pelayanan i JOIN departemen d ON i.id_departemen = d.id where d.id='$id'");
...
<body>
    ...
    <div class="container-fluid bg-breadcrumb">
      <div class="container text-center py-5" style="max-width: 900px;">
        ...
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
          ...
          <li class="breadcrumb-item active text-primary"><?php echo $data1['nama_departemen']; ?></li>
        </ol>
      </div>
    </div>
    <!-- Header End -->
      ...
      <div class="table-responsive wow fadeInUp" data-wow-delay="0.2s">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            $no = 1;
            $sql = $koneksi->query("SELECT i.*, d.nama_departemen FROM informasi_pelayanan i JOIN departemen d ON i.id_departemen = d.id where d.id='$id'");
  ...
  <div id="" class="container-fluid about pt-5 ">
    <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px">
      <h4 class="text-warning">Layanan Kami</h4>
      <h1 class="display-5 mb-4">Layanan <?php echo $data1['nama_departemen']; ?></h1>
      <p class="mb-0">
      Jelajahi berbagai layanan menarik di website perpustakaan kami! Temukan koleksi lengkap buku, jurnal, dan sumber digital yang siap mendukung kebutuhan belajar dan penelitian Anda. 
    ...
    <div class="container-fluid about py-5 ">
      ...
      $services_departement = $mysqli->get_show_services_departement($id);
      ?>
      <div class="container">
        <?php
    ...
    <?php if ($data1['nama_departemen'] == "Perpustakaan" || $data1['nama_departemen'] == "perpustakaan") { ?>
        <div class="container py-5" id="databuku">
          <div class="text-center mx-auto wow fadeInUp pt-5" data-wow-delay="0.2s" style="max-width: 800px">
            <h4 class="text-warning">Data Buku</h4>
            <h1 class="display-5 mb-4">Cari Informasi Tentang Buku</h1>
            <p class="mb-0">
