        ...
        <div class="container pb-5">
            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <p class="text-muted"><?php echo htmlspecialchars($blog['tanggal']); ?> |
                        <?php echo htmlspecialchars($blog['penulis']); ?></p>
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="blog-img mb-4">
                            <img src="img/<?php echo htmlspecialchars($blog['gambar']); ?>"
                                class="img-fluid rounded w-100" alt="<?php echo htmlspecialchars($blog['judul']); ?>" />
                        </div>
                    </div>

                </div>
            </div>
            <div class="text-center mx-auto  wow fadeInUp pb-5" data-wow-delay="0.2s" style="max-width: 800px">
                <h1 class="display-5 ">Blog dan Artikel Lainnya</h1>
            </div>
                ...
                ?>
                        <div class="blog-item p-4">
                            ...
                            <div class="text-end mt-4">
                                <a href="articel_blog_detail.php?id=<?php echo $blog['id']; ?>"
                                    class="btn btn-secondary rounded-start rounded-bottom">Selengkapnya</a>
                            </div>
                        </div>
                <?php }
                } else {
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun" id="tahun" class="form-control"
                            placeholder="Masukkan Tahun" value="<?= htmlspecialchars($tahun_filter); ?>">
                    </div>
                    <div class="mb-3">
